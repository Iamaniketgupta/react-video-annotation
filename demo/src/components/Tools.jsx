    ...
    return (
        <>
            ...
            <div className="flex items-center gap-4">
                ...
                {/* NPM Link */}
                <a
                    href="https://www.npmjs.com/package/react-video-annotation-tool"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center text-white bg-stone-700 hover:bg-stone-600 px-4 py-1 rounded-full transition"
                >
                    <FaNpm size={30} className="mr-2" />
